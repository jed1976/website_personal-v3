...
export function Header({ contact }: Props) {
  return (
    <header class="hcard md:flex md:justify-between mb-8">
      <h2 class="font-bold mb-4 md:flex-1 text-gray-900 text-3xl uppercase">
        {contact["p-name"]}
      </h2>

      <div class="md:flex-1 md:text-right text-gray-500">
